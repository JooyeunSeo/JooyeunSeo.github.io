...
1. `/_sass` → 새 폴더(e.g. `'custom'`) 생성 → scss 확장자 파일(e.g. `'_codeblock.scss'`) 생성
   ```scss
...
2. `/assets` → `/css` → `main.scss`
   ...
   ////////////// 커스텀 파일 import 하는 부분 //////////////
   @import "custom/syntax_highlighting_solarized_light";
   /////////////////////////////////////////////////////
...
- 기본 설정에서 <a href="https://mmistakes.github.io/minimal-mistakes/docs/stylesheets/#solarized-light" target="_blank">Solarized Light</a>로 변경했다.
