---
excerpt: "자주 나오는 함정 및 주의할 점"
title: "정보처리기사 실기 코딩 패턴 정리"
header:
...
public class Main {
    public static void main(String[] args) {
        ...
        Child c = new Child();      // 자식 타입으로 자식 객체 참조

        p.print();                  // Child: 출력             (실제 객체 Child가 오버라이딩)
        p.show("test");             // Parent: Object 형을 받음 (Parent 시야에서 문자열을 받는 메서드 찾음)
     // p.onlyChild();              Parent 시야에는 이 메서드가 안 보이기 때문에 에러
