...
public class Camera {               // 부모 클래스(기능 물려주기)
    ...
    public Camera() {               // 생성자 1(생성자 2 호출)
        this("카메라");
    }

    protected Camera(String name) { // 생성자 2
        this.name = name;
    }
...
public class OOP {
    public static void main(String[] args) {
        ...
        b1.modelName = "g3";
     // b1.price = -5000;       // price는 private이기 때문에 직접 접근 불가
        b1.setPrice(-5000);     // setter를 통해서만 price에 접근 가능
        b1.color = "red";
        ...
        if (factoryCam instanceof FactoryCam) {     // 부모 클래스로 정의한 객체로 자식 클래스 메소드 접근
