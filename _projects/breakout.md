...
주어진 과제에 맞춰서 turtle 라이브러리로 게임을 만들어봤는데, pygame과 같은 게임 개발에 적합한 라이브러리가 아니어서 그런지 아쉬운 점이 많았다. 일단 움직임이 뚝뚝 끊기는 느낌 때문에 오래 플레이하기 불편했고 다양한 애니메이션 효과를 넣고 싶어도 기능이 제한적이어서 원하는 것보다 많이 간단하게 만들어졌다. 하지만 부트캠프에서 배운 내용을 토대로 응용하고 게임의 구조를 짜볼 수 있어서 많은 도움이 됐다.
