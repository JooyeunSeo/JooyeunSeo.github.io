...
Udemy Academy의 *100개의 프로젝트로 Python 개발 완전 정복* 부트캠프에서 최종적으로 진행하는 전문 포트폴리오 프로젝트의 첫 번째 과제로 모스 부호 변환기를 제작했다. 이 프로젝트를 통해 부트캠프 초반부에 연습했던 텍스트 기반 프로그램을 직접 만들어 볼 수 있었다.   
